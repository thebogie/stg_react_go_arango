...
type Mutation {
  ...
  loginUser(input: Login!): UserData!
...
func (ec *executionContext) marshalNUserData2backᚋgraphᚋmodelᚐUserData(ctx context.Context, sel ast.SelectionSet, v model.UserData) graphql.Marshaler {
